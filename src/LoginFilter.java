...
public class LoginFilter implements Filter {
    ...
    public void init(FilterConfig fConfig) {
        ...
        allowedURIs.add("setup.html");
        allowedURIs.add("setup.js");
        allowedURIs.add("api/setup");
//        allowedURIs.add("localhost:8080/s23_122b_gbros_project1_war/");
        allowedURIs.add("accounts.spotify.com/en/authorize?client_id=");
    }
